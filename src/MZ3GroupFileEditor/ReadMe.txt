================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: MZ3GroupFileEditor プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した MZ3GroupFileEditor には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには MZ3GroupFileEditor アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

MZ3GroupFileEditor.vcproj
...
MZ3GroupFileEditor.h
   これはアプリケーションのメイン ヘッダー ファイルです。このファイルには、
   Resource.h を含む、その他のプロジェクト固有のヘッダーが含まれていて、
   CMZ3GroupFileEditorApp アプリケーション クラスを宣言します。

MZ3GroupFileEditor.cpp
   これは、アプリケーション クラス CMZ3GroupFileEditorApp を含むメイン アプリケー
   ション ソース ファイルです。

MZ3GroupFileEditor.rc
...
res\MZ3GroupFileEditor.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル MZ3GroupFileEditor.rc に含まれていま
   す。

res\MZ3GroupFileEditor.rc2
...
MZ3GroupFileEditorDlg.h, MZ3GroupFileEditorDlg.cpp - ダイアログ
   これらのファイルは CMZ3GroupFileEditorDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な MZ3GroupFileEditor.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   MZ3GroupFileEditor.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
