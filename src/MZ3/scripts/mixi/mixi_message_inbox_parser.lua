...
--------------------------------------------------
function mixi_message_inbox_parser(parent, body, html)
	mz3.logger_debug("mixi_message_inbox_parser start");
	...
	mz3.logger_debug("mixi_message_inbox_parser end; elapsed : " .. (t2-t1) .. "[msec]");
end
...
----------------------------------------
-- 受信箱
mz3.set_parser("MESSAGE_IN", "mixi.mixi_message_inbox_parser");
...
--
function on_creating_default_group_for_mixi_message_inbox(serialize_key, event_name, group)
